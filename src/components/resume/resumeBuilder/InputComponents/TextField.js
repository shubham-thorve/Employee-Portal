...
function TextField(props) {
  ...
  const validateInput = (inputValue) => {
    ...
    if (props.validation && props.validation.required && inputValue === "") {
      error = "*required!";
    } else if (
      props.validation &&
      props.validation.maxLengthRequired &&
      inputValue.length > props.validation.maxLengthRequired 
     
    ) {
      error = `write up to ${props.validation.maxLengthRequired} characters`;
    } else if (props.validation && props.validation.checkType === "email") {
  ...
  const handleInputChange = (e) => {
    ...
    if (props.onChange) {
      props.onChange(inputValue, error);
    }
  };
...
//       props.validation &&
//       props.validation.maxLengthRequired &&
//       value.length > props.validation.maxLengthRequired
//     ) {
//       error = `write up to ${props.validation.maxLengthRequired} characters`;
//     } else if (props.validation && props.validation.checkType === "email") {
//       if (!/\S+@\S+\.\S+/.test(value)) {
...
//   return (
//     <div className="w-100 h-100 position-relative">
//       {/* Show error message when value is not empty or showErrorMessages is true */}
...
//         }}
//         onBlur={handleBlur} // Check validation onBlur
//       />
//     </div>
//   );
// }
