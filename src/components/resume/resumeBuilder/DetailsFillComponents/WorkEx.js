  ...
  return (
    <div className='p-5' style={{textAlign:"left"}}>
                    ...
                    <div className="container p-2 font" style={{textAlign:"left"}}>
                        ...
                        <div className="row font">
                            <div className="col-lg-6 col-12 pt-5 px-4">                                
                                    <label className="col-sm-12 col-12" htmlFor="title" >Job Title<span className="resume-errmsg">*</span>
                                        <TextField  
                            ...
                            <div className="col-lg-6 col-12 pt-5 px-4">  
                                    <label className="col-sm-12 col-12" htmlFor="name" >Organization Name<span className="resume-errmsg">*</span>
        ...
        <div className='d-flex'>
            <button 
                className='resume-button mt-3 me-5 mb-3 ml-1 p-2'
                onClick={AddExperience}
            >
                Add new
            </button>
            <button 
                className='resume-button btn-primary mt-3 ms-5 mb-3 ml-1 p-2'
