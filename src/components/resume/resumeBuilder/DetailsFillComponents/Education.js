  ...
  return (
    <div className="container p-4 font" style={{textAlign:"left"}}>
        ...
        {educationHeads.map((educationHeading,index)=>{
            return(
                <div key={index}>
                    ...
                    <div className="row font">
                        <div className="col-lg-6 col-12 pt-5 px-4"> 
                            <label  className="col-md-12 col-12" htmlFor="University">University<span className="resume-errmsg">*</span>
                        ...
                        <div className="col-lg-6 col-12 pt-5 px-4"> 
                            <label  className="col-md-12 col-12" htmlFor="degree">Degree<span className="resume-errmsg">*</span>
        ...
        <div className='d-flex'>
                ...
                <button 
                    className='resume-button mt-3 ms-5 mb-3 ml-1 p-2'
