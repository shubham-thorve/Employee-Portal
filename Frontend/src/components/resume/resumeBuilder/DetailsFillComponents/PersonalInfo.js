...
function PersonalInfo(props) {
 ...
 const showErrorMessages = useSelector(
  (state) => state.dataStore.showErrorMessages
);
  ...
  const getEmployeeById = () => {
    EmployeeService.getEmployeeById()
      .then((response) => {
        ...
        dispatch(updatePersonalInfo({ key: 'firstName', value: response.data.firstName }));
        dispatch(updatePersonalInfo({ key: 'lastName', value: response.data.lastName }));
        dispatch(updatePersonalInfo({ key: 'Email', value: response.data.email }));
        dispatch(updatePersonalInfo({ key: 'Mobile', value: response.data.phoneNo || '' }));
        dispatch(updatePersonalInfo({ key: 'Address1', value: response.data.address || '' }));
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  useEffect(() => {
    // Fetch the personal info from the API and update the state
    getEmployeeById();
  }, [dispatch]);
    ...
    <div style={{padding:"15px", textAlign:"left",}}>
        <div>
          <div>
            ...
            {/* profileImg={personalHeads.profileImg} updateProfileImg={(img)=>{dispatch(updatePersonalInfo({key:'profileImg',value:img}));}} */}
          </div>
          <div className="row font" >
              <div className="col-lg-6 col-12 pt-5 px-4">
                <div className='row d-flex align-items-center'>
                  <div className='col-sm-2 col-12'>
                    <label htmlFor="firstname" className="col-form-label ">First Name<span className="resume-errmsg">*</span></label>
                  </div>
          ...
          <div className="row font" >
              <div className="col-lg-6 col-12 pt-5 px-4">
                <div className='row '>
                  <div className='col-sm-2  col-12'>
                      <label htmlFor="staticEmail" className="col-sm-1 col-form-label d-flex align-items-center">Email<span className="resume-errmsg">*</span></label>
                  </div>
                  <div className="col-sm-10  col-12">
          ...
          <div className="row font">
              <div className="col-lg-6 col-12 pt-5 px-4">
                <div className='row d-flex align-items-center'>
                  <div className='col-sm-2  col-12'>
                      <label htmlFor="mobile" className="col-sm-1 col-form-label ">Mobile No.<span className="resume-errmsg">*</span></label>
                  </div>
                  <div className="col-sm-10  col-12">
          ...
          <div className="row font">
              <div className="col-lg-6 col-12 pt-5 px-4">
                <div className='row '>
                  <div className='col-sm-2  col-12'>
                    <label htmlFor="inputCity" className="col-sm-1 col-form-label">City<span className="resume-errmsg">*</span></label>
                  </div>
                  <div className="col-sm-10 col-12">
