...
export const dataStoreSlice = createSlice({
  ...
  reducers: {
    ...
    updatePersonalInfo: (state,action) => { 
       // Use immer to create a draft of the state object
       return produce(state, draftState => {
        // Update the targeted key of the personalInfo element of dataStore
        draftState.personalInfo[action.payload.key] = action.payload.value
      })
    },
